document.body.insertAdjacentHTML(`afterbegin`, `<header class="header-primary"><a href="/"><div class="main-info"><img src="/assets/images/favicon.png" alt="Header logo"><div class="info"><p class="name">Streamer.bot Actions</p><p class="description">By Ik1497</p></div></div></a><aside><button class="mdi mdi-cog settings"></button></aside></header>`)
