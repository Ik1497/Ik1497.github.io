function reloadTabSets() {
  document.querySelectorAll(`div.tabset:not([data-loaded])`).forEach(tabset => {
    ...
    tabset__activeIndicator.className = `tabset-active-indicator`
    ...
    tabset.querySelectorAll(`div[data-tab]`).forEach((tab, tabIndex) => {
      ...
      tabset__Nav__Ul__Li__Button.addEventListener(`click`, () => {
        ...
        tabset.querySelectorAll(`div[data-tab][data-state="active"], div[data-tab][data-state="becoming-active"]`).forEach(tab => {
